...
{
	//added by xuewu
	time_t jobEndTime = time(NULL);
	job_ptr->endTime = jobEndTime;
	static time_t totalExecuteTime = 0;
	totalExecuteTime = totalExecuteTime + (job_ptr->endTime - job_ptr->startTime);
	static time_t totalSpentTime = 0;
	totalSpentTime = totalSpentTime + (job_ptr->endTime - job_ptr->submitTime);
	info("job end: job_id = %d\ttime = %d\n",job_ptr->job_id,jobEndTime);
	info("job total execute time = %d\n",totalExecuteTime);
	info("job total spent time = %d\n",totalSpentTime);
