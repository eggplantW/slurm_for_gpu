...
typedef struct gres_job_state {
	...
	bitstr_t *gpu_bitmap;	//wx gres
	slurm_addr_t *addr;	//wx gres
...
extern void gpu_plugin_job_dealloc(List job_gres_list,List node_gres_list,int index,char *name,time_t t);
