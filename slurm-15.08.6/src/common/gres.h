...
extern void gres_plugin_job_set_core_info(List job_gres_list,int index,uint16_t core_cnt,slurm_addr_t addr);
extern bitstr_t* gres_plugin_job_get_nodebitmap(List job_gres_list);
extern slurm_addr_t* gres_plugin_job_get_slurm_addr(List job_gres_list);
extern uint32_t gres_plugin_job_get_node_cnt(List job_gres_list);
extern bitstr_t** gres_plugin_job_get_gres_bit_alloc(List job_gres_list);
extern uint16_t* gres_plugin_job_get_core_cnt(List job_gres_list);
extern slurm_addr_t* gres_plugin_job_get_core_node_slurm_addr(List job_gres_list);
//wx
#endif /* !_GRES_H */
